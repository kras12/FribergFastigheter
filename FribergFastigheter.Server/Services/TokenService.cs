...
namespace FribergFastigheter.Server.Services
{
    ...
    public class TokenService : ITokenService
    {
        ...
        public async Task<string> CreateToken(Broker broker)
        {
            ...
            {
                new Claim(ApplicationUserClaims.UserName, broker.User.UserName!),
                new Claim(ApplicationUserClaims.Email, broker.User.Email!),
                new Claim(ApplicationUserClaims.FirstName, broker.User.FirstName!),
                new Claim(ApplicationUserClaims.LastName, broker.User.LastName!),
